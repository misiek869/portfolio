...
const About = () => {
	...
	return (
		<>
			<div
				id='about'
				className='bg-blue pt-[250px] mt-4  pb-[100px] lg:pb-[600px] relative lg:h-[800px]'>
				<div className='container m-auto'>
					<h1 className='text-[240px] w-[80%] overflow-hidden absolute lg:left-40 md:left-30 top-[250px]  text-white text-opacity-5'>
						About Me
					</h1>
